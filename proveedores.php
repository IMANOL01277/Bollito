...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['crear_proveedor'])) {
    ...
    $query = "INSERT INTO proveedores (nombre, contacto, telefono, correo, direccion, fecha_registro)
...
$proveedores = pg_query($conn, "SELECT * FROM proveedores ORDER BY id_proveedor DESC");
?>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                <?php while ($row = pg_fetch_assoc($proveedores)): ?>
                    <tr>
