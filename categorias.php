...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['crear_categoria'])) {
    ...
    if ($nombre === "") {
        ...
        $query = "INSERT INTO categorias (nombre, descripcion, fecha_registro) VALUES ($1, $2, CURRENT_TIMESTAMP)";
...
$categorias = pg_query($conn, "SELECT * FROM categorias ORDER BY id_categoria DESC");
?>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                <?php while ($row = pg_fetch_assoc($categorias)): ?>
                    <tr>
